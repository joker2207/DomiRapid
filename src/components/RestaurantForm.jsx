...
const RestaurantForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Guardar los datos del restaurante en el localStorage
    const restaurants = JSON.parse(localStorage.getItem('restaurants')) || [];
    restaurants.push(formData);
    localStorage.setItem('restaurants', JSON.stringify(restaurants));

    // Mostrar mensaje de confirmación
    setMessage(`Negocio registrado. Este es su usuario: ${formData.username} y su contraseña: ${formData.password}. No la comparta con nadie.`);
